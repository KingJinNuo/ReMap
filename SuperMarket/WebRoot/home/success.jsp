...
<div class="am-container header">
  ...
  <ul class="message-r">
    <div class="topMessage home"><div class="menu-hd"><a href="${pageContext.request.contextPath}/action/toMain" target="_top" class="h">商城首页</a></div></div>
    <div class="topMessage my-shangcheng"><div class="menu-hd MyShangcheng"><a href="${pageContext.request.contextPath}/orderaction/queryorder" target="_top"><i class="am-icon-user am-icon-fw"></i>个人中心</a></div></div>
    <div class="topMessage mini-cart"><div class="menu-hd"><a id="mc-menu-hd" href="${pageContext.request.contextPath}/home/shopcart.jsp" target="_top"><i class="am-icon-shopping-cart  am-icon-fw"></i><span>购物车</span><strong id="J_MiniCartNum" class="h"></strong></a></div></div>
...
<div class="take-delivery">
 <div class="status">
   ...
   <div class="successInfo">
     <ul>
       <li>付款金额<em>¥<s:property value="#session.ordertotals"/></em></li>
       <div class="user-info">
         <p>收货人：${usingaddress.ad_name}</p>
         <p>联系电话：${usingaddress.ad_tel}</p>
         <p><font size="4px">河南省 | 郑州市 | 金水区 | 大中华小区:&nbsp; ${usingaddress.ad_add}</font></p>
       </div>
